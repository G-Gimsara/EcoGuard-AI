    ...
    <main className="relative min-h-screen w-full flex flex-col items-center justify-center text-white font-sans overflow-x-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl mb-20">
          {/* Dashboard Card */}
          <div className="group cursor-pointer bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-3xl shadow-2xl hover:bg-white/20 transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-gray-300 mb-6">
              Access real-time data monitoring for future risk predictions and
              detailed analysis.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-gray-300 leading-relaxed text-lg">
                Your body cools itself by sweating. When{" "}
                <strong>heat and humidity</strong> combine, sweat cannot
                evaporate effectively. This failure in natural cooling can
                quickly lead to{" "}
